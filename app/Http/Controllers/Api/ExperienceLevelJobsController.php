...
class ExperienceLevelJobsController extends Controller
{
    /**
     ...
     */
    public function index(Request $request, ExperienceLevel $experienceLevel)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, ExperienceLevel $experienceLevel)
    {
        ...
        $job = $experienceLevel->jobs()->create($validated);
